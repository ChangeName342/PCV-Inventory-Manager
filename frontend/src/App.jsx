...
function App() {
  ...
  const [isMenuOpen, setIsMenuOpen] = useState(false); // para menú responsivo
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            <ul className="flex gap-6 text-black font-semibold">
              <li className="hover:text-green-600 transition-colors cursor-pointer">Inicio</li>
              <li className="hover:text-green-600 transition-colors cursor-pointer">Valores</li>
              <li className="hover:text-green-600 transition-colors cursor-pointer">Contacto</li>
            </ul>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-12 text-gray-700 text-lg md:text-xl">
          <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-3xl shadow-lg hover:shadow-2xl transition-shadow transform hover:-translate-y-2">
            ...
            <p>
              Continuar el legado del puerto más antiguo del sur de Chile, mantener la tradición fluvial y conectar la industria forestal de La Araucanía, Los Ríos y Los Lagos con el mundo. Este proyecto se enfoca exclusivamente en Portuaria Corral Valdivia.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-3xl shadow-lg hover:shadow-2xl transition-shadow transform hover:-translate-y-2">
            ...
            <p className="mt-2">
              Garantizar que los procesos de registro, consulta y control de inventario sean seguros, trazables y coordinados entre áreas para fortalecer la toma de decisiones.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-3xl shadow-lg hover:shadow-2xl transition-shadow transform hover:-translate-y-2">
            ...
            <p>
              Ser un referente estratégico en la producción y exportación de astillas y pellets de alta calidad, mediante procesos eficientes, seguros y sustentables, promoviendo la sustentabilidad y el desarrollo local, siempre enfocados en Portuaria Corral Valdivia.
            </p>
          </div>
        </div>
      </section>
